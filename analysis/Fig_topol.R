...
results.4<-c(correct.tp.ls[1],correct.tp.nodist[1],correct.tp.ml[1],
             ...
             correct.tp.ls[6],correct.tp.nodist[6],correct.tp.ml[6])
...
par(mfrow=c(3,1),oma=c(3,2,1,0),mar=c(1,2,2,2))
...
bxp(res4.box,outline=F,medpch=rep(c(16,17,18),4),medcex=1.6,whisklty=1,whisklwd=1.5,staplewex=1,staplelwd=1.5,boxwex=0.12,axes=F,add=T)
...
rect(3.5,-1,6.5,1.05,border="gray90",col="gray90")
rect(9.5,-1,12.5,1.05,border="gray90",col="gray90")
bxp(res5.box,outline=F,medpch=rep(c(16,17),4),medcex=1.6,whisklty=1,whisklwd=1.5,staplewex=1,staplelwd=1.5,boxwex=0.12,axes=F,add=T)
axis(2,at=seq(0,1,by=0.25),label=c(0,0.25,0.5,0.75,1))
...
rect(3.5,-1,6.5,1.05,border="gray90",col="gray90")
rect(9.5,-1,12.5,1.05,border="gray90",col="gray90")
bxp(res6.box,outline=F,medpch=rep(c(16,17),4),medcex=1.6,whisklty=1,whisklwd=1.5,staplewex=1,staplelwd=1.5,boxwex=0.12,axes=F,add=T)
axis(2,at=seq(0,1,by=0.25),label=c(0,0.25,0.5,0.75,1))
