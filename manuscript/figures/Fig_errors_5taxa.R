...
# This file performs the simulations on a five taxa tree
# and make the corresponding figure
...
save.image(here("manuscript", "output", "Fig_errors_5taxa.RData"))
load(here("manuscript", "output", "Fig_errors_5taxa.RData"))
