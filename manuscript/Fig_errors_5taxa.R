...
reps <- 10000
my.tree<-read.newick(here("analysis", "tree_files", "sim_phylo5-9.tree"))
...
save.image("C:/Users/pchi01/Dropbox/Villanova/Research/LeastSquares/phyloLSnoDist/analysis/Fig_errors_5taxa_10k.RData")
load("C:/Users/pchi01/Dropbox/Villanova/Research/LeastSquares/phyloLSnoDist/analysis/Fig_errors_5taxa.RData")

### Old with L1/L2
pdf(here("analysis", "Fig_errors_5taxa.pdf"),height=6.5,width=6.5)
par(mfrow=c(2,1),oma=c(3,2.5,1.5,0),mar=c(1,1,0,1))
plot(unroot(my.tree),type="u",show.tip.label=F,y.lim=c(-0.05,0.5))
mtext("Five taxa, Scenario ULE2",side=3, cex=1.5)
...
legend("topleft",c(" ", " "),fill=c("white","gray"), cex=1.5)
text(1.5, 2.3, "L", vfont=c("script","bold"), cex=1.75)
text(1.5, 1.85, "L", vfont=c("script","bold"), cex=1.75)
text(1.8, 2.17, "1", cex=0.8)
text(1.8, 1.72, "2", cex=0.8)
